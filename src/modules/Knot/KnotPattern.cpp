...
KnotControl KnotPattern::charToControl(char c) {
    switch (c) {
        case 'S': return ShiftDown;
        case 's': return ShiftUp;
        case 'R': return Reset;
        case '1': return Swap12;
        case '2': return Swap23;
        case '3': return Swap34;
        case '4': return Swap14;
        case '5': return Swap13;
        case '6': return Swap24;
        case '7': return Swap1234;
        case '8': return Swap1423;
        case '9': return Swap1324;
        case 'U': return Undo;
        case 'u': return Redo;
        case 'X': return Random;
